...
private:
	KH_HitResult CastRay(KH_BVH& BVH, KH_Ray& Ray);

	glm::vec3 PathTracing(KH_BVH& BVH, KH_Ray& Ray, unsigned int Depth);

	KH_HitResult CastRayBase(KH_BVH& BVH, KH_Ray& Ray);

	KH_HitResult CastRayBVH(KH_BVH& BVH, KH_Ray& Ray);
