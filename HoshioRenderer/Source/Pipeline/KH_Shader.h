...
public:
    ...
    KH_Shader DisneyBSDF_0;
    KH_Shader DisneyBSDF_1;
    KH_Shader DisneyBSDF_2;
    KH_Shader DisneyBSDF_3;
    KH_Shader DisneyBSDF_4;
    KH_Shader DisneyBSDF_5;
    KH_Shader DisneyBSDF_6;
